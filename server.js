...
app.get('/paytm', (req, res) => {
    ...
    var paytmParams = {
		...
		"CALLBACK_URL" : `${DOMAIN}success?name=${req.query.name}&email=${req.query.email}&mobile=${req.query.mobile}&branch=${req.query.branch}&year=${req.query.year}&college=${collegeName.val()}&event=${req.query.event}&amount=${req.query.amount}`,
	};
